...
export const CLEARED = [
  ...
  'CODEBURN_ANTIGRAVITY_TOOLS_DIR',
  'CODEBURN_ANTIGRAVITY_TOOLS_LOCAL_IPS',
  'CODEBURN_ANTIGRAVITY_TOOLS_TOKENS_ONLY',
  'CODEBURN_CC_SWITCH_DIR',
  'CODEBURN_NEWAPI_DB',
  'CODEBURN_NEWAPI_LOCAL_TOKENS',
  'CODEBURN_NEWAPI_LOCAL_USERS',
  'WORKBUDDY_HOME',
  'WORKBUDDY_AI_HOME',
